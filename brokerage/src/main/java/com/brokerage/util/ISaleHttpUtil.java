...
public class ISaleHttpUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ISaleHttpUtil.class);
    ...
    private String xAuthToken = "3dc4cca2-5ccb-4ccc-ae8d-9f5566171859";
    private final String u_info = "ab2a90da-2390-4d54-b971-d9a2eb66b02e";
    ...
    private String custOrderToken = "4Z6Nj15CRJyDZMsrjAqo4x";
    ...
    public String getWithCookie(String url) {
        ...
        httpGet.setHeader("X-SysUserCode", userCode);
...
//                httpclient.close();
    ...
    public String postWithCookieFormData(String url, Map<String, Object> params) {
        ...
        httppost.setHeader("X-SysUserCode", userCode);
